...
List<IsarLinkBase<dynamic>> _imageEntityGetLinks(ImageEntity object) {
  return [object.petsitter, object.pet];
}
...
extension ImageEntityQueryLinks
  ...
  QueryBuilder<ImageEntity, ImageEntity, QAfterFilterCondition> pet(
      FilterQuery<Pet> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ImageEntity, ImageEntity, QAfterFilterCondition> petIsNull() {
    return QueryBuilder.apply(this, (query) {
